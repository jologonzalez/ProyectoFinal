...
import com.example.jorgelopez.proyectofinal.Vistas.Presenter.IRegistroPresenter;
import com.example.jorgelopez.proyectofinal.Vistas.Presenter.RegistroPresenter;
...
public class RegistroFragment extends Fragment implements IRegistroFragmentView{
    ...
    @OnClick(R.id.tvYaTengoCuenta)
    @Override
    public void yaTengoUsusario() {
        registroPresenter.yaTengoUsuario();
    }
